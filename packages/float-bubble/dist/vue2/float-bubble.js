...
function normalizeComponent(scriptExports, render2, staticRenderFns, functionalTemplate, injectStyles, scopeId, moduleIdentifier, shadowMode) {
  const options = typeof scriptExports === 'function' ? scriptExports.options : scriptExports
  if (render2) {
...
const _sfc_render = function render() {
  ...
  }, [_vm._t('default', () => [_c('div', { staticClass: 'float-bubble-default', class: [_vm.bubbleClass], style: [_vm.sizeStyle] }, [_vm.text ? _c('span', [_vm._v(_vm._s(_vm.text))]) : _vm.image ? _c('img', { staticClass: 'w-2/3', attrs: { src: _vm.image, alt: '' } }) : _c('span', { staticClass: 'text-center' }, [_vm._v(` ${_vm._s(_vm.writeOffset.x)} `), _c('br'), _vm._v(` ${_vm._s(_vm.writeOffset.y)} `)])])])], 2)
}
const _sfc_staticRenderFns = []
